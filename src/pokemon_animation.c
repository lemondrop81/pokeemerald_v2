...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    // Custom
    [SPECIES_PLAGUAR - 1]                   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_PHOTOGUAR - 1]                 = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_RAIAD - 1]                     = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_RUSALKA - 1]                   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_FALLSHEER - 1]                 = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SCUIRET - 1]                   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_PTERORET - 1]                  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_BIRROBIRD - 1]                 = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_EAGELEAG - 1]                  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_GRIFFOGRIF - 1]                = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MAFICHU - 1]                   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DEMICHU - 1]                   = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_CUTBIT - 1]                    = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_FLABBIT - 1]                   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BLITZRDRIX - 1]                = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_NEINSOUL - 1]                  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SPRUVYNE - 1]                  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_QUERVYNE - 1]                  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SAMPERVYNE - 1]                = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_RANGIFE - 1]                   = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_TARANALLOY - 1]                = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ALCESTEEL - 1]                 = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_ARAKID - 1]                    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_RAKIDONE - 1]                  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_TOTEMNA - 1]                   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_PSKULPT - 1]                   = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_ESPATCH - 1]                   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_FIZZIX - 1]                    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_GRAVITOMIX - 1]                = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_AMUNATU - 1]                   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_GROPP - 1]                     = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_CYCLOBBER - 1]                 = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_TOTSICLE - 1]                  = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW,
    [SPECIES_FROSTIDON - 1]                 = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GLACRIEK - 1]                  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_AMEOERG - 1]                   = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_SARPHON - 1]                   = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_AEROPHAGUS - 1]                = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_ROXXIK - 1]                    = BACK_ANIM_H_SHAKE,
    [SPECIES_GRAVELISK - 1]                 = BACK_ANIM_H_SHAKE,
    [SPECIES_SKARMOROS - 1]                 = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_PHENYXY - 1]                   = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_RESURAKETH - 1]                = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_TORKYLLIUM - 1]                = BACK_ANIM_H_SHAKE,
    [SPECIES_MINOTRANT - 1]                 = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_ZIGGLYGRUF - 1]                = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GOMM - 1]                      = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_MOUNTEGROM - 1]                = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_OVARAPT - 1]                   = BACK_ANIM_H_SHAKE,
    [SPECIES_VELOKOTA - 1]                  = BACK_ANIM_H_SHAKE,
    [SPECIES_UTABAZAI - 1]                  = BACK_ANIM_H_SHAKE,
    [SPECIES_KROA - 1]                      = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KROAEA - 1]                    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_KROAEAKAOA - 1]                = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_ARCHIGLOOM - 1]                = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_NEMELT - 1]                    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_VARAFLARE - 1]                 = BACK_ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_LLURSCAYF - 1]                 = BACK_ANIM_H_SLIDE,
    [SPECIES_CRANISECT - 1]                 = BACK_ANIM_H_SLIDE,
    [SPECIES_SKULTULANT - 1]                = BACK_ANIM_H_SLIDE,
    [SPECIES_CHRYSAL - 1]                   = BACK_ANIM_H_SLIDE,
    [SPECIES_VELLAVALE - 1]                 = BACK_ANIM_H_SLIDE,
    [SPECIES_VELLIDAXOS - 1]                = BACK_ANIM_H_SLIDE,
    [SPECIES_GHOULSLASH - 1]                = BACK_ANIM_SHAKE_GLOW_RED,
};
