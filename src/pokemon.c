...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(KIPVINE),
    SPECIES_TO_HOENN(PLAGUAR),
    SPECIES_TO_HOENN(PHOTOGUAR),
    SPECIES_TO_HOENN(RAIAD),
    SPECIES_TO_HOENN(RUSALKA),
    SPECIES_TO_HOENN(FALLSHEER),
    SPECIES_TO_HOENN(SCUIRET),
    SPECIES_TO_HOENN(PTERORET),
    SPECIES_TO_HOENN(BIRROBIRD),
    SPECIES_TO_HOENN(EAGELEAG),
    SPECIES_TO_HOENN(GRIFFOGRIF),
    SPECIES_TO_HOENN(MAFICHU),
    SPECIES_TO_HOENN(DEMICHU),
    SPECIES_TO_HOENN(CUTBIT),
    SPECIES_TO_HOENN(FLABBIT),
    SPECIES_TO_HOENN(BLITZRDRIX),
    SPECIES_TO_HOENN(NEINSOUL),
    SPECIES_TO_HOENN(SPRUVYNE),
    SPECIES_TO_HOENN(QUERVYNE),
    SPECIES_TO_HOENN(SAMPERVYNE),
    SPECIES_TO_HOENN(RANGIFE),
    SPECIES_TO_HOENN(TARANALLOY),
    SPECIES_TO_HOENN(ALCESTEEL),
    SPECIES_TO_HOENN(ARAKID),
    SPECIES_TO_HOENN(RAKIDONE),
    SPECIES_TO_HOENN(TOTEMNA),
    SPECIES_TO_HOENN(PSKULPT),
    SPECIES_TO_HOENN(ESPATCH),
    SPECIES_TO_HOENN(FIZZIX),
    SPECIES_TO_HOENN(GRAVITOMIX),
    SPECIES_TO_HOENN(AMUNATU),
    SPECIES_TO_HOENN(GROPP),
    SPECIES_TO_HOENN(CYCLOBBER),
    SPECIES_TO_HOENN(TOTSICLE),
    SPECIES_TO_HOENN(FROSTIDON),
    SPECIES_TO_HOENN(GLACRIEK),
    SPECIES_TO_HOENN(AMEOERG),
    SPECIES_TO_HOENN(SARPHON),
    SPECIES_TO_HOENN(AEROPHAGUS),
    SPECIES_TO_HOENN(ROXXIK),
    SPECIES_TO_HOENN(GRAVELISK),
    SPECIES_TO_HOENN(SKARMOROS),
    SPECIES_TO_HOENN(PHENYXY),
    SPECIES_TO_HOENN(RESURAKETH),
    SPECIES_TO_HOENN(TORKYLLIUM),
    SPECIES_TO_HOENN(MINOTRANT),
    SPECIES_TO_HOENN(ZIGGLYGRUF),
    SPECIES_TO_HOENN(GOMM),
    SPECIES_TO_HOENN(MOUNTEGROM),
    SPECIES_TO_HOENN(OVARAPT),
    SPECIES_TO_HOENN(VELOKOTA),
    SPECIES_TO_HOENN(UTABAZAI),
    SPECIES_TO_HOENN(KROA),
    SPECIES_TO_HOENN(KROAEA),
    SPECIES_TO_HOENN(KROAEAKAOA),
    SPECIES_TO_HOENN(ARCHIGLOOM),
    SPECIES_TO_HOENN(NEMELT),
    SPECIES_TO_HOENN(VARAFLARE),
    SPECIES_TO_HOENN(KOMODOR),
    SPECIES_TO_HOENN(SILHOU),
    SPECIES_TO_HOENN(SILGAUNT),
    SPECIES_TO_HOENN(VAILEYE),
    SPECIES_TO_HOENN(BLOODNAUNT),
    SPECIES_TO_HOENN(ANPHAGE),
    SPECIES_TO_HOENN(TUSGOYF),
    SPECIES_TO_HOENN(LLURSCAYF),
    SPECIES_TO_HOENN(CRANISECT),
    SPECIES_TO_HOENN(SKULTULANT),
    SPECIES_TO_HOENN(CHRYSAL),
    SPECIES_TO_HOENN(VELLAVALE),
    SPECIES_TO_HOENN(VELLIDAXOS),
    SPECIES_TO_HOENN(GHOULSLASH),
    SPECIES_TO_HOENN(MURKEON),
    SPECIES_TO_HOENN(OBSIDEON),
    SPECIES_TO_HOENN(FUREON),
    SPECIES_TO_HOENN(SOOTHEON),
    SPECIES_TO_HOENN(MOOREON),
    SPECIES_TO_HOENN(FROSTEON),
    SPECIES_TO_HOENN(RADEON),
    SPECIES_TO_HOENN(POSPHEON),
    SPECIES_TO_HOENN(PULSEON),
    SPECIES_TO_HOENN(STATICEON),
    SPECIES_TO_HOENN(BLIZZEON),
    SPECIES_TO_HOENN(DYNAMEON),
    SPECIES_TO_HOENN(DEVILEON),
    SPECIES_TO_HOENN(CINDEREON),
    SPECIES_TO_HOENN(BLANEON),
    SPECIES_TO_HOENN(ECLIPSEON),
    SPECIES_TO_HOENN(AROMEON),
    SPECIES_TO_HOENN(ISYCLEON),
    SPECIES_TO_HOENN(ZEREON),
    SPECIES_TO_HOENN(NOCTIVEON),
    SPECIES_TO_HOENN(PINEON),
    SPECIES_TO_HOENN(PIXEON),
    SPECIES_TO_HOENN(LUNNEON),
    SPECIES_TO_HOENN(CHERREON),
    SPECIES_TO_HOENN(HAZEON),
    SPECIES_TO_HOENN(SERENEON),
    SPECIES_TO_HOENN(MISTEON),
    SPECIES_TO_HOENN(PUREON),
    SPECIES_TO_HOENN(SALATAD),
    SPECIES_TO_HOENN(SALANIP),
    SPECIES_TO_HOENN(SALASLAM),
    SPECIES_TO_HOENN(HALMSTAR),
    SPECIES_TO_HOENN(SNUFFUZZ),
    SPECIES_TO_HOENN(STICKIT),
    SPECIES_TO_HOENN(STICKUT),
    SPECIES_TO_HOENN(UGLING),
    SPECIES_TO_HOENN(SWELLEGANT),
    SPECIES_TO_HOENN(ANGLING),
    SPECIES_TO_HOENN(ANGELISH),
    SPECIES_TO_HOENN(ANGELIGHT),
    SPECIES_TO_HOENN(AQUAD),
    SPECIES_TO_HOENN(SMAQUA),
    SPECIES_TO_HOENN(BEOPUP),
    SPECIES_TO_HOENN(WEREHIDE),
    SPECIES_TO_HOENN(VAMBAT),
    SPECIES_TO_HOENN(DRACUBAT),
    SPECIES_TO_HOENN(COUNTULA),
    SPECIES_TO_HOENN(PUPOOL),
    SPECIES_TO_HOENN(POOLDOG),
    SPECIES_TO_HOENN(PORFIN),
    SPECIES_TO_HOENN(DOFLAP),
    SPECIES_TO_HOENN(PARADISO),
    SPECIES_TO_HOENN(PARASEA),
    SPECIES_TO_HOENN(AQLARVA),
    SPECIES_TO_HOENN(MOSLIQUO),
    SPECIES_TO_HOENN(NAWALE),
    SPECIES_TO_HOENN(WHALEY),
    SPECIES_TO_HOENN(SQUIDART),
    SPECIES_TO_HOENN(LISQUID),
    SPECIES_TO_HOENN(HAMAWL),
    SPECIES_TO_HOENN(SILVICIOUS),
};
...
// Custom
    SPECIES_TO_NATIONAL(KIPVINE),
    SPECIES_TO_NATIONAL(PLAGUAR),
    SPECIES_TO_NATIONAL(PHOTOGUAR),
    SPECIES_TO_NATIONAL(RAIAD),
    SPECIES_TO_NATIONAL(RUSALKA),
    SPECIES_TO_NATIONAL(FALLSHEER),
    SPECIES_TO_NATIONAL(SCUIRET),
    SPECIES_TO_NATIONAL(PTERORET),
    SPECIES_TO_NATIONAL(BIRROBIRD),
    SPECIES_TO_NATIONAL(EAGELEAG),
    SPECIES_TO_NATIONAL(GRIFFOGRIF),
    SPECIES_TO_NATIONAL(MAFICHU),
    SPECIES_TO_NATIONAL(DEMICHU),
    SPECIES_TO_NATIONAL(CUTBIT),
    SPECIES_TO_NATIONAL(FLABBIT),
    SPECIES_TO_NATIONAL(BLITZRDRIX),
    SPECIES_TO_NATIONAL(NEINSOUL),
    SPECIES_TO_NATIONAL(SPRUVYNE),
    SPECIES_TO_NATIONAL(QUERVYNE),
    SPECIES_TO_NATIONAL(SAMPERVYNE),
    SPECIES_TO_NATIONAL(RANGIFE),
    SPECIES_TO_NATIONAL(TARANALLOY),
    SPECIES_TO_NATIONAL(ALCESTEEL),
    SPECIES_TO_NATIONAL(ARAKID),
    SPECIES_TO_NATIONAL(RAKIDONE),
    SPECIES_TO_NATIONAL(TOTEMNA),
    SPECIES_TO_NATIONAL(PSKULPT),
    SPECIES_TO_NATIONAL(ESPATCH),
    SPECIES_TO_NATIONAL(FIZZIX),
    SPECIES_TO_NATIONAL(GRAVITOMIX),
    SPECIES_TO_NATIONAL(AMUNATU),
    SPECIES_TO_NATIONAL(GROPP),
    SPECIES_TO_NATIONAL(CYCLOBBER),
    SPECIES_TO_NATIONAL(TOTSICLE),
    SPECIES_TO_NATIONAL(FROSTIDON),
    SPECIES_TO_NATIONAL(GLACRIEK),
    SPECIES_TO_NATIONAL(AMEOERG),
    SPECIES_TO_NATIONAL(SARPHON),
    SPECIES_TO_NATIONAL(AEROPHAGUS),
    SPECIES_TO_NATIONAL(ROXXIK),
    SPECIES_TO_NATIONAL(GRAVELISK),
    SPECIES_TO_NATIONAL(SKARMOROS),
    SPECIES_TO_NATIONAL(PHENYXY),
    SPECIES_TO_NATIONAL(RESURAKETH),
    SPECIES_TO_NATIONAL(TORKYLLIUM),
    SPECIES_TO_NATIONAL(MINOTRANT),
    SPECIES_TO_NATIONAL(ZIGGLYGRUF),
    SPECIES_TO_NATIONAL(GOMM),
    SPECIES_TO_NATIONAL(MOUNTEGROM),
    SPECIES_TO_NATIONAL(OVARAPT),
    SPECIES_TO_NATIONAL(VELOKOTA),
    SPECIES_TO_NATIONAL(UTABAZAI),
    SPECIES_TO_NATIONAL(KROA),
    SPECIES_TO_NATIONAL(KROAEA),
    SPECIES_TO_NATIONAL(KROAEAKAOA),
    SPECIES_TO_NATIONAL(ARCHIGLOOM),
    SPECIES_TO_NATIONAL(NEMELT),
    SPECIES_TO_NATIONAL(VARAFLARE),
    SPECIES_TO_NATIONAL(KOMODOR),
    SPECIES_TO_NATIONAL(SILHOU),
    SPECIES_TO_NATIONAL(SILGAUNT),
    SPECIES_TO_NATIONAL(VAILEYE),
    SPECIES_TO_NATIONAL(BLOODNAUNT),
    SPECIES_TO_NATIONAL(ANPHAGE),
    SPECIES_TO_NATIONAL(TUSGOYF),
    SPECIES_TO_NATIONAL(LLURSCAYF),
    SPECIES_TO_NATIONAL(CRANISECT),
    SPECIES_TO_NATIONAL(SKULTULANT),
    SPECIES_TO_NATIONAL(CHRYSAL),
    SPECIES_TO_NATIONAL(VELLAVALE),
    SPECIES_TO_NATIONAL(VELLIDAXOS),
    SPECIES_TO_NATIONAL(GHOULSLASH),
    SPECIES_TO_NATIONAL(MURKEON),
    SPECIES_TO_NATIONAL(OBSIDEON),
    SPECIES_TO_NATIONAL(FUREON),
    SPECIES_TO_NATIONAL(SOOTHEON),
    SPECIES_TO_NATIONAL(MOOREON),
    SPECIES_TO_NATIONAL(FROSTEON),
    SPECIES_TO_NATIONAL(RADEON),
    SPECIES_TO_NATIONAL(POSPHEON),
    SPECIES_TO_NATIONAL(PULSEON),
    SPECIES_TO_NATIONAL(STATICEON),
    SPECIES_TO_NATIONAL(BLIZZEON),
    SPECIES_TO_NATIONAL(DYNAMEON),
    SPECIES_TO_NATIONAL(DEVILEON),
    SPECIES_TO_NATIONAL(CINDEREON),
    SPECIES_TO_NATIONAL(BLANEON),
    SPECIES_TO_NATIONAL(ECLIPSEON),
    SPECIES_TO_NATIONAL(AROMEON),
    SPECIES_TO_NATIONAL(ISYCLEON),
    SPECIES_TO_NATIONAL(ZEREON),
    SPECIES_TO_NATIONAL(NOCTIVEON),
    SPECIES_TO_NATIONAL(PINEON),
    SPECIES_TO_NATIONAL(PIXEON),
    SPECIES_TO_NATIONAL(LUNNEON),
    SPECIES_TO_NATIONAL(CHERREON),
    SPECIES_TO_NATIONAL(HAZEON),
    SPECIES_TO_NATIONAL(SERENEON),
    SPECIES_TO_NATIONAL(MISTEON),
    SPECIES_TO_NATIONAL(PUREON),
    SPECIES_TO_NATIONAL(SALATAD),
    SPECIES_TO_NATIONAL(SALANIP),
    SPECIES_TO_NATIONAL(SALASLAM),
    SPECIES_TO_NATIONAL(HALMSTAR),
    SPECIES_TO_NATIONAL(SNUFFUZZ),
    SPECIES_TO_NATIONAL(STICKIT),
    SPECIES_TO_NATIONAL(STICKUT),
    SPECIES_TO_NATIONAL(UGLING),
    SPECIES_TO_NATIONAL(SWELLEGANT),
    SPECIES_TO_NATIONAL(ANGLING),
    SPECIES_TO_NATIONAL(ANGELISH),
    SPECIES_TO_NATIONAL(ANGELIGHT),
    SPECIES_TO_NATIONAL(AQUAD),
    SPECIES_TO_NATIONAL(SMAQUA),
    SPECIES_TO_NATIONAL(BEOPUP),
    SPECIES_TO_NATIONAL(WEREHIDE),
    SPECIES_TO_NATIONAL(VAMBAT),
    SPECIES_TO_NATIONAL(DRACUBAT),
    SPECIES_TO_NATIONAL(COUNTULA),
    SPECIES_TO_NATIONAL(PUPOOL),
    SPECIES_TO_NATIONAL(POOLDOG),
    SPECIES_TO_NATIONAL(PORFIN),
    SPECIES_TO_NATIONAL(DOFLAP),
    SPECIES_TO_NATIONAL(PARADISO),
    SPECIES_TO_NATIONAL(PARASEA),
    SPECIES_TO_NATIONAL(AQLARVA),
    SPECIES_TO_NATIONAL(MOSLIQUO),
    SPECIES_TO_NATIONAL(NAWALE),
    SPECIES_TO_NATIONAL(WHALEY),
    SPECIES_TO_NATIONAL(SQUIDART),
    SPECIES_TO_NATIONAL(LISQUID),
    SPECIES_TO_NATIONAL(HAMAWL),
    SPECIES_TO_NATIONAL(SILVICIOUS),
};
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(KIPVINE),
    HOENN_TO_NATIONAL(PLAGUAR),
    HOENN_TO_NATIONAL(PHOTOGUAR),
    HOENN_TO_NATIONAL(RAIAD),
    HOENN_TO_NATIONAL(RUSALKA),
    HOENN_TO_NATIONAL(FALLSHEER),
    HOENN_TO_NATIONAL(SCUIRET),
    HOENN_TO_NATIONAL(PTERORET),
    HOENN_TO_NATIONAL(BIRROBIRD),
    HOENN_TO_NATIONAL(EAGELEAG),
    HOENN_TO_NATIONAL(GRIFFOGRIF),
    HOENN_TO_NATIONAL(MAFICHU),
    HOENN_TO_NATIONAL(DEMICHU),
    HOENN_TO_NATIONAL(CUTBIT),
    HOENN_TO_NATIONAL(FLABBIT),
    HOENN_TO_NATIONAL(BLITZRDRIX),
    HOENN_TO_NATIONAL(NEINSOUL),
    HOENN_TO_NATIONAL(SPRUVYNE),
    HOENN_TO_NATIONAL(QUERVYNE),
    HOENN_TO_NATIONAL(SAMPERVYNE),
    HOENN_TO_NATIONAL(RANGIFE),
    HOENN_TO_NATIONAL(TARANALLOY),
    HOENN_TO_NATIONAL(ALCESTEEL),
    HOENN_TO_NATIONAL(ARAKID),
    HOENN_TO_NATIONAL(RAKIDONE),
    HOENN_TO_NATIONAL(TOTEMNA),
    HOENN_TO_NATIONAL(PSKULPT),
    HOENN_TO_NATIONAL(ESPATCH),
    HOENN_TO_NATIONAL(FIZZIX),
    HOENN_TO_NATIONAL(GRAVITOMIX),
    HOENN_TO_NATIONAL(AMUNATU),
    HOENN_TO_NATIONAL(GROPP),
    HOENN_TO_NATIONAL(CYCLOBBER),
    HOENN_TO_NATIONAL(TOTSICLE),
    HOENN_TO_NATIONAL(FROSTIDON),
    HOENN_TO_NATIONAL(GLACRIEK),
    HOENN_TO_NATIONAL(AMEOERG),
    HOENN_TO_NATIONAL(SARPHON),
    HOENN_TO_NATIONAL(AEROPHAGUS),
    HOENN_TO_NATIONAL(ROXXIK),
    HOENN_TO_NATIONAL(GRAVELISK),
    HOENN_TO_NATIONAL(SKARMOROS),
    HOENN_TO_NATIONAL(PHENYXY),
    HOENN_TO_NATIONAL(RESURAKETH),
    HOENN_TO_NATIONAL(TORKYLLIUM),
    HOENN_TO_NATIONAL(MINOTRANT),
    HOENN_TO_NATIONAL(ZIGGLYGRUF),
    HOENN_TO_NATIONAL(GOMM),
    HOENN_TO_NATIONAL(MOUNTEGROM),
    HOENN_TO_NATIONAL(OVARAPT),
    HOENN_TO_NATIONAL(VELOKOTA),
    HOENN_TO_NATIONAL(UTABAZAI),
    HOENN_TO_NATIONAL(KROA),
    HOENN_TO_NATIONAL(KROAEA),
    HOENN_TO_NATIONAL(KROAEAKAOA),
    HOENN_TO_NATIONAL(ARCHIGLOOM),
    HOENN_TO_NATIONAL(NEMELT),
    HOENN_TO_NATIONAL(VARAFLARE),
    HOENN_TO_NATIONAL(KOMODOR),
    HOENN_TO_NATIONAL(SILHOU),
    HOENN_TO_NATIONAL(SILGAUNT),
    HOENN_TO_NATIONAL(VAILEYE),
    HOENN_TO_NATIONAL(BLOODNAUNT),
    HOENN_TO_NATIONAL(ANPHAGE),
    HOENN_TO_NATIONAL(TUSGOYF),
    HOENN_TO_NATIONAL(LLURSCAYF),
    HOENN_TO_NATIONAL(CRANISECT),
    HOENN_TO_NATIONAL(SKULTULANT),
    HOENN_TO_NATIONAL(CHRYSAL),
    HOENN_TO_NATIONAL(VELLAVALE),
    HOENN_TO_NATIONAL(VELLIDAXOS),
    HOENN_TO_NATIONAL(GHOULSLASH),
    HOENN_TO_NATIONAL(MURKEON),
    HOENN_TO_NATIONAL(OBSIDEON),
    HOENN_TO_NATIONAL(FUREON),
    HOENN_TO_NATIONAL(SOOTHEON),
    HOENN_TO_NATIONAL(MOOREON),
    HOENN_TO_NATIONAL(FROSTEON),
    HOENN_TO_NATIONAL(RADEON),
    HOENN_TO_NATIONAL(POSPHEON),
    HOENN_TO_NATIONAL(PULSEON),
    HOENN_TO_NATIONAL(STATICEON),
    HOENN_TO_NATIONAL(BLIZZEON),
    HOENN_TO_NATIONAL(DYNAMEON),
    HOENN_TO_NATIONAL(DEVILEON),
    HOENN_TO_NATIONAL(CINDEREON),
    HOENN_TO_NATIONAL(BLANEON),
    HOENN_TO_NATIONAL(ECLIPSEON),
    HOENN_TO_NATIONAL(AROMEON),
    HOENN_TO_NATIONAL(ISYCLEON),
    HOENN_TO_NATIONAL(ZEREON),
    HOENN_TO_NATIONAL(NOCTIVEON),
    HOENN_TO_NATIONAL(PINEON),
    HOENN_TO_NATIONAL(PIXEON),
    HOENN_TO_NATIONAL(LUNNEON),
    HOENN_TO_NATIONAL(CHERREON),
    HOENN_TO_NATIONAL(HAZEON),
    HOENN_TO_NATIONAL(SERENEON),
    HOENN_TO_NATIONAL(MISTEON),
    HOENN_TO_NATIONAL(PUREON),
    HOENN_TO_NATIONAL(SALATAD),
    HOENN_TO_NATIONAL(SALANIP),
    HOENN_TO_NATIONAL(SALASLAM),
    HOENN_TO_NATIONAL(HALMSTAR),
    HOENN_TO_NATIONAL(SNUFFUZZ),
    HOENN_TO_NATIONAL(STICKIT),
    HOENN_TO_NATIONAL(STICKUT),
    HOENN_TO_NATIONAL(UGLING),
    HOENN_TO_NATIONAL(SWELLEGANT),
    HOENN_TO_NATIONAL(ANGLING),
    HOENN_TO_NATIONAL(ANGELISH),
    HOENN_TO_NATIONAL(ANGELIGHT),
    HOENN_TO_NATIONAL(AQUAD),
    HOENN_TO_NATIONAL(SMAQUA),
    HOENN_TO_NATIONAL(BEOPUP),
    HOENN_TO_NATIONAL(WEREHIDE),
    HOENN_TO_NATIONAL(VAMBAT),
    HOENN_TO_NATIONAL(DRACUBAT),
    HOENN_TO_NATIONAL(COUNTULA),
    HOENN_TO_NATIONAL(PUPOOL),
    HOENN_TO_NATIONAL(POOLDOG),
    HOENN_TO_NATIONAL(PORFIN),
    HOENN_TO_NATIONAL(DOFLAP),
    HOENN_TO_NATIONAL(PARADISO),
    HOENN_TO_NATIONAL(PARASEA),
    HOENN_TO_NATIONAL(AQLARVA),
    HOENN_TO_NATIONAL(MOSLIQUO),
    HOENN_TO_NATIONAL(NAWALE),
    HOENN_TO_NATIONAL(WHALEY),
    HOENN_TO_NATIONAL(SQUIDART),
    HOENN_TO_NATIONAL(LISQUID),
    HOENN_TO_NATIONAL(HAMAWL),
    HOENN_TO_NATIONAL(SILVICIOUS),
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    // Custom
    [SPECIES_KIPVINE - 1]                   = ANIM_V_JUMPS_SMALL,
    [SPECIES_PLAGUAR - 1]                   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PHOTOGUAR - 1]                 = ANIM_TUMBLING_FRONT_FLIP_TWICE,
    [SPECIES_RAIAD - 1]                     = ANIM_V_SHAKE_TWICE,
    [SPECIES_RUSALKA - 1]                   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FALLSHEER - 1]                 = ANIM_V_SHAKE_TWICE,
    [SPECIES_SCUIRET - 1]                   = ANIM_FRONT_FLIP,
    [SPECIES_PTERORET - 1]                  = ANIM_FRONT_FLIP,
    [SPECIES_BIRROBIRD - 1]                 = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_EAGELEAG - 1]                  = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_GRIFFOGRIF - 1]                = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_MAFICHU - 1]                   = ANIM_FLASH_YELLOW,
    [SPECIES_DEMICHU - 1]                   = ANIM_FLASH_YELLOW,
    [SPECIES_CUTBIT - 1]                    = ANIM_RAPID_H_HOPS,
    [SPECIES_FLABBIT - 1]                   = ANIM_RAPID_H_HOPS,
    [SPECIES_BLITZRDRIX - 1]                = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_NEINSOUL - 1]                  = ANIM_GROW_VIBRATE,
    [SPECIES_SPRUVYNE - 1]                  = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_QUERVYNE - 1]                  = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_SAMPERVYNE - 1]                = ANIM_RAPID_H_HOPS,
    [SPECIES_RANGIFE - 1]                   = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_TARANALLOY - 1]                = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_ALCESTEEL - 1]                 = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_ARAKID - 1]                    = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
    [SPECIES_RAKIDONE - 1]                  = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
    [SPECIES_TOTEMNA - 1]                   = ANIM_GROW_VIBRATE,
    [SPECIES_PSKULPT - 1]                   = ANIM_GROW_VIBRATE,
    [SPECIES_ESPATCH - 1]                   = ANIM_GROW_VIBRATE,
    [SPECIES_FIZZIX - 1]                    = ANIM_SHRINK_GROW,
    [SPECIES_GRAVITOMIX - 1]                = ANIM_SHRINK_GROW,
    [SPECIES_AMUNATU - 1]                   = ANIM_GROW_VIBRATE,
    [SPECIES_GROPP - 1]                     = ANIM_H_SHAKE_SLOW,
    [SPECIES_CYCLOBBER - 1]                 = ANIM_H_SHAKE_SLOW,
    [SPECIES_TOTSICLE - 1]                  = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW,
    [SPECIES_FROSTIDON - 1]                 = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW,
    [SPECIES_GLACRIEK - 1]                  = ANIM_TUMBLING_FRONT_FLIP_TWICE,
    [SPECIES_AMEOERG - 1]                   = ANIM_TUMBLING_FRONT_FLIP_TWICE,
    [SPECIES_SARPHON - 1]                   = ANIM_H_SLIDE,
    [SPECIES_AEROPHAGUS - 1]                = ANIM_H_SLIDE,
    [SPECIES_ROXXIK - 1]                    = ANIM_V_STRETCH,
    [SPECIES_GRAVELISK - 1]                 = ANIM_V_STRETCH,
    [SPECIES_SKARMOROS - 1]                 = ANIM_V_SHAKE,
    [SPECIES_PHENYXY - 1]                   = ANIM_RISING_WOBBLE,
    [SPECIES_RESURAKETH - 1]                = ANIM_RISING_WOBBLE,
    [SPECIES_TORKYLLIUM - 1]                = ANIM_V_STRETCH,
    [SPECIES_MINOTRANT - 1]                 = ANIM_V_SHAKE_TWICE,
    [SPECIES_ZIGGLYGRUF - 1]                = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_GOMM - 1]                      = ANIM_ZIGZAG_SLOW,
    [SPECIES_MOUNTEGROM - 1]                = ANIM_ZIGZAG_SLOW,
    [SPECIES_OVARAPT - 1]                   = ANIM_H_SHAKE,
    [SPECIES_VELOKOTA - 1]                  = ANIM_H_SHAKE,
    [SPECIES_UTABAZAI - 1]                  = ANIM_H_SHAKE,
    [SPECIES_KROA - 1]                      = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_KROAEA - 1]                    = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_KROAEAKAOA - 1]                = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_ARCHIGLOOM - 1]                = ANIM_RISING_WOBBLE,
    [SPECIES_NEMELT - 1]                    = ANIM_BACK_AND_LUNGE,
    [SPECIES_VARAFLARE - 1]                 = ANIM_BACK_AND_LUNGE,
    [SPECIES_KOMODOR - 1]                   = ANIM_BACK_AND_LUNGE,
    [SPECIES_SILHOU - 1]                    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SILGAUNT - 1]                  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLOODNAUNT - 1]                = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_ANPHAGE - 1]                   = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_TUSGOYF - 1]                   = ANIM_RAPID_H_HOPS,
    [SPECIES_LLURSCAYF - 1]                 = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRANISECT - 1]                 = ANIM_GROW_VIBRATE,
    [SPECIES_SKULTULANT - 1]                = ANIM_GLOW_BLACK,
    [SPECIES_CHRYSAL - 1]                   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VELLAVALE - 1]                 = ANIM_RAPID_H_HOPS,
    [SPECIES_VELLIDAXOS - 1]                = ANIM_GROW_VIBRATE,
    [SPECIES_GHOULSLASH - 1]                = ANIM_GLOW_BLACK,
    [SPECIES_MURKEON - 1]                   = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_OBSIDEON - 1]                  = ANIM_ZIGZAG_SLOW,
    [SPECIES_FUREON - 1]                    = ANIM_ZIGZAG_SLOW,
    [SPECIES_SOOTHEON - 1]                  = ANIM_H_SHAKE,
    [SPECIES_MOOREON - 1]                   = ANIM_H_SHAKE,
    [SPECIES_FROSTEON - 1]                  = ANIM_H_SHAKE,
    [SPECIES_RADEON - 1]                    = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_POSPHEON - 1]                  = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_PULSEON - 1]                   = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_STATICEON - 1]                 = ANIM_RISING_WOBBLE,
    [SPECIES_BLIZZEON - 1]                  = ANIM_BACK_AND_LUNGE,
    [SPECIES_DYNAMEON - 1]                  = ANIM_BACK_AND_LUNGE,
    [SPECIES_DEVILEON - 1]                  = ANIM_BACK_AND_LUNGE,
    [SPECIES_CINDEREON - 1]                 = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLANEON - 1]                   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ECLIPSEON - 1]                 = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_AROMEON - 1]                   = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_ISYCLEON - 1]                  = ANIM_RAPID_H_HOPS,
    [SPECIES_ZEREON - 1]                    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NOCTIVEON - 1]                 = ANIM_GROW_VIBRATE,
    [SPECIES_PINEON - 1]                    = ANIM_GLOW_BLACK,
    [SPECIES_PIXEON - 1]                    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUNNEON - 1]                   = ANIM_RAPID_H_HOPS,
    [SPECIES_CHERREON - 1]                  = ANIM_GROW_VIBRATE,
    [SPECIES_HAZEON - 1]                    = ANIM_GLOW_BLACK,
    [SPECIES_SERENEON - 1]                  = ANIM_RAPID_H_HOPS,
    [SPECIES_MISTEON - 1]                   = ANIM_GROW_VIBRATE,
    [SPECIES_PUREON - 1]                    = ANIM_GLOW_BLACK,
    [SPECIES_SALATAD - 1]                   = ANIM_GLOW_BLACK,
    [SPECIES_SALANIP - 1]                   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SALASLAM - 1]                  = ANIM_RAPID_H_HOPS,
    [SPECIES_HALMSTAR - 1]                  = ANIM_GROW_VIBRATE,
    [SPECIES_SNUFFUZZ - 1]                  = ANIM_GLOW_BLACK,
    [SPECIES_STICKIT - 1]                   = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_STICKUT - 1]                   = ANIM_ZIGZAG_SLOW,
    [SPECIES_UGLING - 1]                    = ANIM_ZIGZAG_SLOW,
    [SPECIES_SWELLEGANT - 1]                = ANIM_H_SHAKE,
    [SPECIES_ANGLING - 1]                   = ANIM_H_SHAKE,
    [SPECIES_ANGELISH - 1]                  = ANIM_H_SHAKE,
    [SPECIES_ANGELIGHT - 1]                 = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_AQUAD - 1]                     = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_SMAQUA - 1]                    = ANIM_SHRINK_GROW_VIBRATE_FAST,
    [SPECIES_BEOPUP - 1]                    = ANIM_RISING_WOBBLE,
    [SPECIES_WEREHIDE - 1]                  = ANIM_BACK_AND_LUNGE,
    [SPECIES_VAMBAT - 1]                    = ANIM_BACK_AND_LUNGE,
    [SPECIES_DRACUBAT - 1]                  = ANIM_BACK_AND_LUNGE,
    [SPECIES_COUNTULA - 1]                  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PUPOOL - 1]                    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_POOLDOG - 1]                   = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_PORFIN - 1]                    = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_DOFLAP - 1]                    = ANIM_RAPID_H_HOPS,
    [SPECIES_PARADISO - 1]                  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PARASEA - 1]                   = ANIM_GROW_VIBRATE,
    [SPECIES_AQLARVA - 1]                   = ANIM_GLOW_BLACK,
    [SPECIES_MOSLIQUO - 1]                  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NAWALE - 1]                    = ANIM_RAPID_H_HOPS,
    [SPECIES_WHALEY - 1]                    = ANIM_GROW_VIBRATE,
    [SPECIES_SQUIDART - 1]                  = ANIM_GLOW_BLACK,
    [SPECIES_LISQUID - 1]                   = ANIM_RAPID_H_HOPS,
    [SPECIES_HAMAWL - 1]                    = ANIM_GROW_VIBRATE,
    [SPECIES_SILVICIOUS - 1]                = ANIM_GLOW_BLACK,
};
