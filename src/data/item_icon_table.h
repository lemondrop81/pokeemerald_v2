const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_AQUIX] = {gItemIcon_Aquix, gItemIconPalette_Aquix},
    [ITEM_BURIX] = {gItemIcon_Burix, gItemIconPalette_Burix},
    [ITEM_ELECTRIX] = {gItemIcon_Electrix, gItemIconPalette_Electrix},
    [ITEM_PATHIX] = {gItemIcon_Pathix, gItemIconPalette_Pathix},
    [ITEM_PIXIX] = {gItemIcon_Pixix, gItemIconPalette_Pixix},
    [ITEM_VERDIX] = {gItemIcon_Verdix, gItemIconPalette_Verdix},
    [ITEM_VOIDIX] = {gItemIcon_Voidix, gItemIconPalette_Voidix},
    [ITEM_ZERIX] = {gItemIcon_Zerix, gItemIconPalette_Zerix},
    // Nectars
