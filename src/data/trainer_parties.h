...
static const struct TrainerMonNoItemDefaultMoves sParty_Tiana[] = {
    ...
    .iv = 100,
    .lvl = 4,
    .species = SPECIES_CUTBIT,
    },
    {
    .iv = 100,
    .lvl = 4,
    .species = SPECIES_BEOPUP,
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv5[] = {
    ...
    .lvl = 33,
    .species = SPECIES_JOLTEON,
    .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_TRAILBLAZE, MOVE_SWAGGER}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_FLAREON,
    .moves = {MOVE_FLARE_BLITZ, MOVE_GIGA_IMPACT, MOVE_TERA_BLAST, MOVE_DIG}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_VAPOREON,
    .moves = {MOVE_SURF, MOVE_BLIZZARD, MOVE_ACID_ARMOR, MOVE_CALM_MIND}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_UMBREON,
    .moves = {MOVE_DARK_PULSE, MOVE_MOONLIGHT, MOVE_LAST_RESORT, MOVE_TRAILBLAZE}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_GLACEON,
    .moves = {MOVE_BLIZZARD, MOVE_PSYCHIC, MOVE_CURSE, MOVE_CHILLING_WATER}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Miguel5[] = {
    ...
    .iv = 100,
    .lvl = 32,
    .species = SPECIES_SWELLEGANT,
    .heldItem = ITEM_SITRUS_BERRY
    },
    {
    .iv = 100,
    .lvl = 32,
    .species = SPECIES_PORFIN,
    .heldItem = ITEM_SITRUS_BERRY
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Pete[] = {
    ...
    .iv = 100,
    .lvl = 15,
    .species = SPECIES_RAIAD,
    },
    {
    .iv = 100,
    .lvl = 15,
    .species = SPECIES_KROAEA,
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Isabelle[] = {
    ...
    .iv = 100,
    .lvl = 15,
    .species = SPECIES_UGLING,
    },
    {
    .iv = 100,
    .lvl = 15,
    .species = SPECIES_AQLARVA,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy2[] = {
    ...
    .species = SPECIES_HALMSTAR,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ROLLOUT, MOVE_HYPER_FANG, MOVE_BABY_DOLL_EYES, MOVE_BITE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_HALMSTAR,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_CRUNCH, MOVE_SUPER_FANG, MOVE_SLAM, MOVE_REST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winston5[] = {
    ...
    .species = SPECIES_SCUIRET,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_METAL_CLAW, MOVE_SCARY_FACE, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .moves = {MOVE_EARTH_POWER, MOVE_TRI_ATTACK, MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER}
    },
    {
    .iv = 150,
    .lvl = 23,
    .species = SPECIES_LUCARIO,
    .moves = {MOVE_DARK_PULSE, MOVE_BONE_RUSH, MOVE_BLIZZARD, MOVE_THUNDER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .moves = {MOVE_AURA_SPHERE, MOVE_DARK_PULSE, MOVE_EARTHQUAKE, MOVE_SCALD}
    },
    {
    .iv = 150,
    .lvl = 17,
    .species = SPECIES_KABUTO,
    .moves = {MOVE_POISON_FANG, MOVE_BUG_BUZZ, MOVE_DARK_PULSE, MOVE_SECRET_POWER}
    },
    {
    .iv = 150,
    .lvl = 17,
    .species = SPECIES_SHINX,
    .moves = {MOVE_POISON_JAB, MOVE_CRUNCH, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Timmy[] = {
    ...
    .iv = 100,
    .lvl = 15,
    .species = SPECIES_FIZZIX,
    },
    {
    .iv = 100,
    .lvl = 13,
    .species = SPECIES_VAILEYE,
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .iv = 100,
    .lvl = 15,
    .species = SPECIES_TOTEMNA,
    .moves = {MOVE_ANCIENT_POWER, MOVE_TRI_ATTACK, MOVE_POWER_GEM, MOVE_PSYCHIC}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jaclyn[] = {
    ...
    .iv = 100,
    .lvl = 16,
    .species = SPECIES_ISYCLEON,
    .moves = {MOVE_BLIZZARD, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_EARTH_POWER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 15,
    .species = SPECIES_HALMSTAR,
    .moves = {MOVE_CRUNCH, MOVE_SUPER_FANG, MOVE_BULLDOZE, MOVE_OVERHEAT}
    },
    {
    .iv = 90,
    .lvl = 17,
    .species = SPECIES_CUTBIT,
    .moves = {MOVE_THRASH, MOVE_PSYCHO_CUT, MOVE_AERIAL_ACE, MOVE_POISON_TAIL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg2[] = {
    ...
    .lvl = 15,
    .species = SPECIES_SCYTHER,
    .moves = {MOVE_ICICLE_CRASH, MOVE_CLOSE_COMBAT, MOVE_NIGHT_SLASH, MOVE_SHADOW_CLAW}
    },
    {
    .iv = 90,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg3[] = {
    ...
    .iv = 150,
    .lvl = 15,
    .species = SPECIES_ANPHAGE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_HORN_LEECH, MOVE_X_SCISSOR, MOVE_POISON_JAB}
    },
    {
    .iv = 150,
    .lvl = 17,
    .species = SPECIES_CHRYSAL,
    .moves = {MOVE_DARK_PULSE, MOVE_LEECH_LIFE, MOVE_IRON_DEFENSE, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Celina[] = {
    ...
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_CHERREON,
    },
    {
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_SOOTHEON,
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Heidi[] = {
    ...
    .lvl = 22,
    .species = SPECIES_LUCARIO,
    .moves = {MOVE_DARK_PULSE, MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 100,
    .lvl = 22,
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_GRIMER,
    .moves = {MOVE_SUBMISSION, MOVE_EARTHQUAKE, MOVE_SLUDGE_WAVE, MOVE_FLAMETHROWER}
    },
    {
    .iv = 100,
    .lvl = 21,
    .species = SPECIES_TANGELA,
    .moves = {MOVE_POWER_WHIP, MOVE_ANCIENT_POWER, MOVE_EARTHQUAKE, MOVE_BODY_SLAM}
    },
    {
    .iv = 100,
    .lvl = 21,
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .lvl = 23,
    .species = SPECIES_COMBEE,
    .moves = {MOVE_LAVA_PLUME, MOVE_SIGNAL_BEAM, MOVE_MIRROR_SHOT, MOVE_METAL_SOUND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 22,
    .species = SPECIES_SHINX,
    .moves = {MOVE_POISON_JAB, MOVE_IRON_TAIL, MOVE_SHADOW_BALL, MOVE_EARTHQUAKE}
    },
    {
    .iv = 100,
    .lvl = 22,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brooke1[] = {
    ...
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_DEVILEON,
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_PULSEON,
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_BLIZZEON,
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_PIXEON,
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_PUREON,
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_ECLIPSEON,
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vicky[] = {
    ...
    .lvl = 18,
    .species = SPECIES_GOMM,
    .moves = {MOVE_MOONBLAST, MOVE_EARTH_POWER, MOVE_FOUL_PLAY, MOVE_MEGA_PUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 19,
    .species = SPECIES_SUNKERN,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_FIRE_BLAST, MOVE_ENERGY_BALL, MOVE_THIEF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline2[] = {
    ...
    .lvl = 19,
    .species = SPECIES_JIGGLYPUFF,
    .moves = {MOVE_FACADE, MOVE_PUNISHMENT, MOVE_ROLLOUT, MOVE_BOUNCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .lvl = 19,
    .species = SPECIES_ZIGGLYGRUF,
    .moves = {MOVE_PLAY_ROUGH, MOVE_DRAIN_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 150,
    .lvl = 19,
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 18,
    .species = SPECIES_SCRAGGY,
    .moves = {MOVE_WOOD_HAMMER, MOVE_HEAD_SMASH, MOVE_BOUNCE, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 100,
    .lvl = 20,
    .species = SPECIES_RAICHU,
    .moves = {MOVE_THUNDERBOLT, MOVE_DOUBLE_TEAM, MOVE_TRAILBLAZE, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy2[] = {
    ...
    .lvl = 33,
    .species = SPECIES_MINOTRANT,
    .moves = {MOVE_STORM_THROW, MOVE_HEAD_SMASH, MOVE_MEGAHORN, MOVE_PLAY_ROUGH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_HURRICANE, MOVE_THUNDER, MOVE_BOOMBURST, MOVE_SLUDGE_WAVE}
    },
    {
    .iv = 100,
    .lvl = 25,
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .moves = {MOVE_THUNDER, MOVE_PLAY_ROUGH, MOVE_GRASS_KNOT, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Riley[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SQUIRTLE,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_DARK_PULSE, MOVE_VACUUM_WAVE, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_AMNESIA, MOVE_BOOMBURST, MOVE_THUNDERBOLT, MOVE_HURRICANE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_ROXXIK,
    .moves = {MOVE_BODY_PRESS, MOVE_LUNGE, MOVE_POISON_JAB, MOVE_SPIKY_SHIELD}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_RAIAD,
    .moves = {MOVE_MOONBLAST, MOVE_SPARKLING_ARIA, MOVE_OMINOUS_WIND, MOVE_BELCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .lvl = 30,
    .species = SPECIES_SPRUVYNE,
    .moves = {MOVE_WOOD_HAMMER, MOVE_GRASSY_TERRAIN, MOVE_GRASS_WHISTLE, MOVE_DRAGON_RUSH}
    },
    {
    .iv = 100,
    .lvl = 32,
    .species = SPECIES_SILHOU,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_PHANTOM_FORCE, MOVE_MEGA_PUNCH, MOVE_BRUTAL_SWING}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Myles[] = {
    ...
    .iv = 10,
    .lvl = 25,
    .species = SPECIES_POSPHEON,
    },
    {
    .iv = 10,
    .lvl = 25,
    .species = SPECIES_BLANEON,
    },
    {
    .iv = 10,
    .lvl = 25,
    ...
    .iv = 10,
    .lvl = 25,
    .species = SPECIES_LUNNEON,
    },
    {
    .iv = 10,
    .lvl = 25,
    .species = SPECIES_HAZEON,
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_NEINSOUL,
    .moves = {MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_DARK_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 29,
    .species = SPECIES_BERGMITE,
    .moves = {MOVE_SANDSTORM, MOVE_OUTRAGE, MOVE_CRUNCH, MOVE_ROCK_WRECKER}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_BIRROBIRD,
    .moves = {MOVE_FLY, MOVE_SUBMISSION, MOVE_GRAV_APPLE, MOVE_ROOST}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_POSPHEON,
    .moves = {MOVE_NIGHT_SLASH, MOVE_THUNDER, MOVE_DARK_PULSE, MOVE_SMOG}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_ROXXIK,
    .moves = {MOVE_POISON_TAIL, MOVE_STRENGTH_SAP, MOVE_BODY_PRESS, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 28,
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayley[] = {
    ...
    .lvl = 39,
    .species = SPECIES_BULBASAUR,
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHO_BOOST, MOVE_MOONLIGHT, MOVE_HYPER_BEAM}
    },
    {
    .iv = 100,
    .lvl = 29,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 32,
    .species = SPECIES_AMUNATU,
    .moves = {MOVE_DRAGON_PULSE, MOVE_PSYCHIC, MOVE_BRAVE_BIRD, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .species = SPECIES_FUREON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_CRUNCH}
    },
    {
    .iv = 100,
    .lvl = 32,
...
static const struct TrainerMonNoItemCustomMoves sParty_Aaron[] = {
    ...
    .lvl = 34,
    .species = SPECIES_CHARMANDER,
    .moves = {MOVE_OUTRAGE, MOVE_PHANTOM_FORCE, MOVE_DARK_PULSE, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marley[] = {
    ...
    .species = SPECIES_GLACRIEK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_POISON_JAB, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 34,
    .species = SPECIES_AMEOERG,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GUNK_SHOT, MOVE_ICE_PUNCH, MOVE_IRON_TAIL, MOVE_AQUA_TAIL}
    },
    {
    .iv = 255,
    .lvl = 34,
    .species = SPECIES_TOTSICLE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_PULSE, MOVE_HEAD_SMASH, MOVE_FREEZE_DRY, MOVE_DAZZLING_GLEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .lvl = 39,
    .species = SPECIES_TOTSICLE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_FREEZE_DRY, MOVE_DAZZLING_GLEAM, MOVE_SURF}
    },
    {
    .iv = 200,
    .lvl = 39,
...
static const struct TrainerMonNoItemCustomMoves sParty_Cedric[] = {
    ...
    .lvl = 32,
    .species = SPECIES_ESPEON,
    .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM, MOVE_GRASS_KNOT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .lvl = 17,
    .species = SPECIES_VAILEYE,
    .moves = {MOVE_DARK_PULSE, MOVE_PRISMATIC_LASER, MOVE_METEOR_BEAM, MOVE_MOONGEIST_BEAM}
    },
    {
    .iv = 250,
    .lvl = 12,
    .species = SPECIES_GLALIE,
    .moves = {MOVE_ROCK_BLAST, MOVE_CRUNCH, MOVE_FLARE_BLITZ, MOVE_HEAD_SMASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_SARPHON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PAIN_SPLIT, MOVE_EXPLOSION, MOVE_SHADOW_BALL, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .species = SPECIES_CYCLOBBER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HEAVY_SLAM, MOVE_HAMMER_ARM, MOVE_BRUTAL_SWING, MOVE_STOMPING_TANTRUM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .iv = 250,
    .lvl = 12,
    .species = SPECIES_ESPATCH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SANDSTORM, MOVE_EXPLOSION, MOVE_PSYCHIC, MOVE_ANCIENT_POWER}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_BEOPUP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_DOUBLE_EDGE, MOVE_LEER, MOVE_SWAGGER}
    },
    {
    .iv = 100,
    .lvl = 16,
    ...
    .species = SPECIES_UMBREON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DARK_PULSE, MOVE_MOONLIGHT, MOVE_LAST_RESORT, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_VAILEYE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DARK_PULSE, MOVE_ZAP_CANNON, MOVE_MOONGEIST_BEAM, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 200,
    .lvl = 16,
    ...
    .species = SPECIES_LUCARIO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AURA_SPHERE, MOVE_DRAGON_PULSE, MOVE_DRAIN_PUNCH, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = {
    ...
    .species = SPECIES_CHRYSAL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PARTING_SHOT, MOVE_LEECH_LIFE, MOVE_DARK_PULSE, MOVE_NASTY_PLOT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .species = SPECIES_DEVILEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_BODY_PRESS, MOVE_CRUNCH, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_NOCTIVEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEAF_STORM, MOVE_DARK_PULSE, MOVE_SYNTHESIS, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_ZEREON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DARK_PULSE, MOVE_BLIZZARD, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .species = SPECIES_ECLIPSEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_MOONLIGHT, MOVE_LAST_RESORT, MOVE_DARK_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .lvl = 17,
    .species = SPECIES_FLABBIT,
    .moves = {MOVE_DISCHARGE, MOVE_EXTRASENSORY, MOVE_INFESTATION, MOVE_SLASH}
    },
    {
    .iv = 100,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 17,
    .species = SPECIES_EEVEE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_TRUMP_CARD, MOVE_BABY_DOLL_EYES, MOVE_THUNDERBOLT}
    },
    {
    .iv = 150,
    .lvl = 17,
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_STICKIT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_HORN_LEECH, MOVE_CHIP_AWAY, MOVE_X_SCISSOR}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_GROPP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIZZY_PUNCH, MOVE_SMACK_DOWN, MOVE_DRAGON_HAMMER, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_RALTS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ELECTRIC_TERRAIN, MOVE_THUNDERBOLT, MOVE_BLIZZARD, MOVE_MOONBLAST}
    },
    {
    .iv = 200,
    .lvl = 20,
    .species = SPECIES_DEMICHU,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 220,
    .lvl = 22,
    ...
    .species = SPECIES_KIPVINE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_FANG, MOVE_EXTREME_SPEED, MOVE_POWER_WHIP, MOVE_JUNGLE_HEALING}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICICLE_CRASH, MOVE_WILD_CHARGE, MOVE_THUNDER_PUNCH, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .species = SPECIES_JOLTEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_HYPER_VOICE, MOVE_DIG}
    },
    {
    .iv = 220,
    .lvl = 22,
    ...
    .species = SPECIES_BLIZZEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_WATER_PULSE, MOVE_ROCK_SMASH}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_PULSEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_RADEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_THUNDER_FANG, MOVE_GIGA_IMPACT, MOVE_SHADOW_BALL}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_PIXEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER, MOVE_MOONBLAST, MOVE_HYPER_VOICE, MOVE_MAGICAL_LEAF}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 23,
    .species = SPECIES_AQUAD,
    .moves = {MOVE_SCALD, MOVE_DRAIN_PUNCH, MOVE_AERIAL_ACE, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_FROSLASS,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_FIERY_DANCE, MOVE_BATON_PASS, MOVE_ENERGY_BALL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 250,
    .lvl = 26,
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_DEFENSE, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_EEVEE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_IRON_TAIL, MOVE_DOUBLE_EDGE, MOVE_FACADE, MOVE_BATON_PASS}
    },
    {
    .iv = 200,
    .lvl = 27,
    .species = SPECIES_CUTBIT,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SLASH, MOVE_ACROBATICS, MOVE_SIGNAL_BEAM, MOVE_PSYCHO_CUT}
    },
    {
    .iv = 200,
    .lvl = 27,
    .species = SPECIES_BIRROBIRD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_BRAVE_BIRD, MOVE_ROOST, MOVE_GRAV_APPLE, MOVE_CRUSH_CLAW}
    },
    {
    .iv = 200,
    .lvl = 29,
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_PLAY_ROUGH, MOVE_DOUBLE_EDGE, MOVE_ROLLOUT, MOVE_FACADE}
    },
    {
    .iv = 250,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_PAWNIARD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_HURRICANE, MOVE_HIGH_JUMP_KICK, MOVE_BLAZE_KICK, MOVE_STONE_EDGE}
    },
    {
    .iv = 210,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_ARAKID,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SPACIAL_REND, MOVE_FREEZING_GLARE, MOVE_LEECH_LIFE, MOVE_ACID_SPRAY}
    },
    {
    .iv = 250,
    .lvl = 42,
    ...
    .species = SPECIES_BULBASAUR,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_PSYCHO_BOOST, MOVE_MOONBLAST, MOVE_MOONLIGHT, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .species = SPECIES_UGLING,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_AIR_SLASH, MOVE_HYDRO_PUMP, MOVE_PERISH_SONG, MOVE_ICE_BEAM}
    },
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_PUPOOL,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_PLAY_ROUGH, MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_AQUA_JET}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    ...
    .species = SPECIES_ANGLING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAINING_KISS, MOVE_HYDRO_PUMP, MOVE_HEART_SWAP, MOVE_DIVE}
    },
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_PARASEA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_GIGA_DRAIN, MOVE_DRAGON_TAIL, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_SALATAD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_POISON_JAB, MOVE_AQUA_TAIL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 200,
    .lvl = 41,
    .species = SPECIES_RAIAD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SHADOW_BALL, MOVE_MOONBLAST, MOVE_SPARKLING_ARIA, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 200,
    .lvl = 43,
    .species = SPECIES_SQUIDART,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SUCKER_PUNCH, MOVE_SLUDGE_WAVE, MOVE_WILD_CHARGE}
    },
    {
    .iv = 200,
    .lvl = 43,
    .species = SPECIES_NAWALE,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_ICICLE_CRASH, MOVE_MEGAHORN, MOVE_AQUA_TAIL, MOVE_SACRED_SWORD}
    },
    {
    .iv = 250,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_CRANISECT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BONE, MOVE_LEECH_LIFE, MOVE_GUNK_SHOT, MOVE_TOXIC_SPIKES}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .species = SPECIES_CHRYSAL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEECH_LIFE, MOVE_DARK_PULSE, MOVE_NASTY_PLOT, MOVE_QUIVER_DANCE}
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_KABUTO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_NIGHT_SHADE, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_ANPHAGE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_FIRST_IMPRESSION, MOVE_DRAGON_CLAW, MOVE_HORN_LEECH}
    }    
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_PURRLOIN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_PLAY_ROUGH, MOVE_SLASH, MOVE_ENERGY_BALL}
    },
    {
    .iv = 250,
    .lvl = 49,
    ...
    .species = SPECIES_CHARMANDER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_OUTRAGE, MOVE_PHANTOM_FORCE, MOVE_POISON_JAB, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICICLE_CRASH, MOVE_WILD_CHARGE, MOVE_SWORDS_DANCE, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 50,
    .species = SPECIES_AMEOERG,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GUNK_SHOT, MOVE_ICE_PUNCH, MOVE_AQUA_TAIL, MOVE_HAIL}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_BLANEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FIRE_BLAST, MOVE_BLIZZARD, MOVE_HAIL, MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_SCIZOR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_ICICLE_CRASH, MOVE_PSYCHO_CUT, MOVE_ROOST}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_RALTS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER, MOVE_BLIZZARD, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .species = SPECIES_BERGMITE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_ROCK_WRECKER, MOVE_OUTRAGE, MOVE_IRON_DEFENSE}
    },
    {
    .iv = 250,
    .lvl = 53,
    .species = SPECIES_SAMPERVYNE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_HAMMER, MOVE_SOLAR_BLADE, MOVE_X_SCISSOR, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_SQUIDART,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SUCKER_PUNCH, MOVE_SHADOW_BALL, MOVE_WILD_CHARGE}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Dudley[] = { // unused
    {
    .iv = 100,
    .lvl = 33,
    .species = SPECIES_TENTACOOL,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kaylee[] = { // Unused
    {
    .iv = 100,
    .lvl = 34,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntUnused[] = { // Unused
    {
    .iv = 100,
    .lvl = 31,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Terry[] = { // Unused
    {
    .iv = 100,
    .lvl = 37,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_WHALEY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_HYPER_VOICE, MOVE_EARTHQUAKE, MOVE_WILD_CHARGE}
    },
    {
    .iv = 150,
    .lvl = 43,
    .species = SPECIES_ARCHIGLOOM,
    .moves = {MOVE_DARK_PULSE, MOVE_MOONBLAST, MOVE_OBLIVION_WING, MOVE_HORN_LEECH}
    },
    {
    .iv = 150,
    .lvl = 44,
    ...
    .lvl = 44,
    .species = SPECIES_SQUIRTLE,
    .moves = {MOVE_AURA_SPHERE, MOVE_EARTHQUAKE, MOVE_SCALD, MOVE_DARK_PULSE}
    },
    {
    .iv = 150,
    .lvl = 41,
