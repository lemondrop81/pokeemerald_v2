const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    // Custom pokemon
    [SPECIES_KIPVINE] = sKipvineLevelUpLearnset,
    [SPECIES_PLAGUAR] = sPlaguarLevelUpLearnset,
    [SPECIES_PHOTOGUAR] = sPhotoguarLevelUpLearnset,
    [SPECIES_RAIAD] = sRaiadLevelUpLearnset,
    [SPECIES_RUSALKA] = sRusalkaLevelUpLearnset,
    [SPECIES_FALLSHEER] = sFallsheerLevelUpLearnset,
    [SPECIES_SCUIRET] = sScuiretLevelUpLearnset,
    [SPECIES_PTERORET] = sPteroretLevelUpLearnset,
    [SPECIES_BIRROBIRD] = sBirrobirdLevelUpLearnset,
    [SPECIES_EAGELEAG] = sEageleagLevelUpLearnset,
    [SPECIES_GRIFFOGRIF] = sGriffogrifLevelUpLearnset,
    [SPECIES_MAFICHU] = sMafichuLevelUpLearnset,
    [SPECIES_DEMICHU] = sDemichuLevelUpLearnset,
    [SPECIES_CUTBIT] = sCutbitLevelUpLearnset,
    [SPECIES_FLABBIT] = sFlabbitLevelUpLearnset,
    [SPECIES_BLITZRDRIX] = sBlitzrdrixLevelUpLearnset,
    [SPECIES_NEINSOUL] = sNeinsoulLevelUpLearnset,
    [SPECIES_SPRUVYNE] = sSpruvyneLevelUpLearnset,
    [SPECIES_QUERVYNE] = sQueryneLevelUpLearnset,
    [SPECIES_SAMPERVYNE] = sSampervyneLevelUpLearnset,
    [SPECIES_RANGIFE] = sRangifeLevelUpLearnset,
    [SPECIES_TARANALLOY] = sTaranalloyLevelUpLearnset,
    [SPECIES_ALCESTEEL] = sAlcesteelLevelUpLearnset,
    [SPECIES_ARAKID] = sArakidLevelUpLearnset,
    [SPECIES_RAKIDONE] = sRakidoneLevelUpLearnset,
    [SPECIES_TOTEMNA] = sTotemnaLevelUpLearnset,
    [SPECIES_PSKULPT] = sPskulptLevelUpLearnset,
    [SPECIES_ESPATCH] = sEspatchLevelUpLearnset,
    [SPECIES_FIZZIX] = sFizzixLevelUpLearnset,
    [SPECIES_GRAVITOMIX] = sGravitomixLevelUpLearnset,
    [SPECIES_AMUNATU] = sAmunatuLevelUpLearnset,
    [SPECIES_GROPP] = sGroppLevelUpLearnset,
    [SPECIES_CYCLOBBER] = sCyclobberLevelUpLearnset,
    [SPECIES_TOTSICLE] = sTotsicleLevelUpLearnset,
    [SPECIES_FROSTIDON] = sFrostidonLevelUpLearnset,
    [SPECIES_GLACRIEK] = sGlacriekLevelUpLearnset,
    [SPECIES_AMEOERG] = sAmeoergLevelUpLearnset,
    [SPECIES_SARPHON] = sSarphonLevelUpLearnset,
    [SPECIES_AEROPHAGUS] = sAerophagusLevelUpLearnset,
    [SPECIES_ROXXIK] = sRoxxikLevelUpLearnset,
    [SPECIES_GRAVELISK] = sGraveliskLevelUpLearnset,
    [SPECIES_SKARMOROS] = sSkarmorosLevelUpLearnset,
    [SPECIES_PHENYXY] = sPhenyxyLevelUpLearnset,
    [SPECIES_RESURAKETH] = sResurakethLevelUpLearnset,
    [SPECIES_TORKYLLIUM] = sTorkylliumLevelUpLearnset,
    [SPECIES_MINOTRANT] = sMinotrantLevelUpLearnset,
    [SPECIES_ZIGGLYGRUF] = sZigglygrufLevelUpLearnset,
    [SPECIES_GOMM] = sGommLevelUpLearnset,
    [SPECIES_MOUNTEGROM] = sMountegromLevelUpLearnset,
    [SPECIES_OVARAPT] = sOvaraptLevelUpLearnset,
    [SPECIES_VELOKOTA] = sVelokotaLevelUpLearnset,
    [SPECIES_UTABAZAI] = sUtabazaiLevelUpLearnset,
    [SPECIES_KROA] = sKroaLevelUpLearnset,
    [SPECIES_KROAEA] = sKroaeaLevelUpLearnset,
    [SPECIES_KROAEAKAOA] = sKroaeakaoaLevelUpLearnset,
    [SPECIES_ARCHIGLOOM] = sArchigloomLevelUpLearnset,
    [SPECIES_NEMELT] = sNemeltLevelUpLearnset,
    [SPECIES_VARAFLARE] = sVaraflareLevelUpLearnset,
    [SPECIES_KOMODOR] = sKomodorLevelUpLearnset,
    [SPECIES_SILHOU] = sSilhouLevelUpLearnset,
    [SPECIES_SILGAUNT] = sSilgauntLevelUpLearnset,
    [SPECIES_VAILEYE] = sVaileyeLevelUpLearnset,
    [SPECIES_BLOODNAUNT] = sBloodnauntLevelUpLearnset,
    [SPECIES_ANPHAGE] = sAnphageLevelUpLearnset,
    [SPECIES_TUSGOYF] = sTusgoyfLevelUpLearnset,
    [SPECIES_LLURSCAYF] = sLlurscayfLevelUpLearnset,
    [SPECIES_CRANISECT] = sCranisectLevelUpLearnset,
    [SPECIES_SKULTULANT] = sSkultulantLevelUpLearnset,
    [SPECIES_CHRYSAL] = sChrysalLevelUpLearnset,
    [SPECIES_VELLAVALE] = sVellavaleLevelUpLearnset,
    [SPECIES_VELLIDAXOS] = sVellidaxosLevelUpLearnset,
    [SPECIES_GHOULSLASH] = sGhoulslashLevelUpLearnset,
    [SPECIES_MURKEON] = sMurkeonLevelUpLearnset,
    [SPECIES_OBSIDEON] = sObsideonLevelUpLearnset,
    [SPECIES_FUREON] = sFureonLevelUpLearnset,
    [SPECIES_SOOTHEON] = sSootheonLevelUpLearnset,
    [SPECIES_MOOREON] = sMooreonLevelUpLearnset,
    [SPECIES_FROSTEON] = sFrosteonLevelUpLearnset,
    [SPECIES_RADEON] = sRadeonLevelUpLearnset,
    [SPECIES_POSPHEON] = sPospheonLevelUpLearnset,
    [SPECIES_PULSEON] = sPulseonLevelUpLearnset,
    [SPECIES_STATICEON] = sStaticeonLevelUpLearnset,
    [SPECIES_BLIZZEON] = sBlizzeonLevelUpLearnset,
    [SPECIES_DYNAMEON] = sDynameonLevelUpLearnset,
    [SPECIES_DEVILEON] = sDevileonLevelUpLearnset,
    [SPECIES_CINDEREON] = sCindereonLevelUpLearnset,
    [SPECIES_BLANEON] = sBlaneonLevelUpLearnset,
    [SPECIES_ECLIPSEON] = sEclipseonLevelUpLearnset,
    [SPECIES_AROMEON] = sAromeonLevelUpLearnset,
    [SPECIES_ISYCLEON] = sIsycleonLevelUpLearnset,
    [SPECIES_ZEREON] = sZereonLevelUpLearnset,
    [SPECIES_NOCTIVEON] = sNoctiveonLevelUpLearnset,
    [SPECIES_PINEON] = sPineonLevelUpLearnset,
    [SPECIES_PIXEON] = sPixeonLevelUpLearnset,
    [SPECIES_LUNNEON] = sLunneonLevelUpLearnset,
    [SPECIES_CHERREON] = sCherreonLevelUpLearnset,
    [SPECIES_HAZEON] = sHazeonLevelUpLearnset,
    [SPECIES_SERENEON] = sSereneonLevelUpLearnset,
    [SPECIES_MISTEON] = sMisteonLevelUpLearnset,
    [SPECIES_PUREON] = sPureonLevelUpLearnset,
    [SPECIES_SALATAD] = sSalatadLevelUpLearnset,
    [SPECIES_SALANIP] = sSalanipLevelUpLearnset,
    [SPECIES_SALASLAM] = sSalaslamLevelUpLearnset,
    [SPECIES_HALMSTAR] = sHalmstarLevelUpLearnset,
    [SPECIES_SNUFFUZZ] = sSnuffuzzLevelUpLearnset,
    [SPECIES_STICKIT] = sStickitLevelUpLearnset,
    [SPECIES_STICKUT] = sStickutLevelUpLearnset,
    [SPECIES_UGLING] = sUglingLevelUpLearnset,
    [SPECIES_SWELLEGANT] = sSwellegantLevelUpLearnset,
    [SPECIES_ANGLING] = sAnglingLevelUpLearnset,
    [SPECIES_ANGELISH] = sAngelishLevelUpLearnset,
    [SPECIES_ANGELIGHT] = sAngelightLevelUpLearnset,
    [SPECIES_AQUAD] = sAquadLevelUpLearnset,
    [SPECIES_SMAQUA] = sSmaquaLevelUpLearnset,
    [SPECIES_BEOPUP] = sBeopupLevelUpLearnset,
    [SPECIES_WEREHIDE] = sWerehideLevelUpLearnset,
    [SPECIES_VAMBAT] = sVambatLevelUpLearnset,
    [SPECIES_DRACUBAT] = sDracubatLevelUpLearnset,
    [SPECIES_COUNTULA] = sCountulaLevelUpLearnset,
    [SPECIES_PUPOOL] = sPupoolLevelUpLearnset,
    [SPECIES_POOLDOG] = sPooldogLevelUpLearnset,
    [SPECIES_PORFIN] = sPorfinLevelUpLearnset,
    [SPECIES_DOFLAP] = sDoflapLevelUpLearnset,
    [SPECIES_PARASEA] = sParaseaLevelUpLearnset,
    [SPECIES_PARADISO] = sParadisoLevelUpLearnset,    
    [SPECIES_AQLARVA] = sAqlarvaLevelUpLearnset,
    [SPECIES_MOSLIQUO] = sMosliquonLevelUpLearnset,
    [SPECIES_NAWALE] = sNawaleLevelUpLearnset,
    [SPECIES_WHALEY] = sWhaleyLevelUpLearnset,
    [SPECIES_SQUIDART] = sSquidartLevelUpLearnset,
    [SPECIES_LISQUID] = sLisquidLevelUpLearnset,
    [SPECIES_HAMAWL] = sHamawlLevelUpLearnset,
    [SPECIES_SILVICIOUS] = sSilviciousLevelUpLearnset,
